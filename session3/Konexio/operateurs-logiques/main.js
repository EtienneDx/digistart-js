...
console.log("faux ou faux", false || false);

// 2. vrai et vrai

console.log("vrai et vrai", true && true);

// 3. pas faux

console.log("pas faux", !false)

// 4. pas pas vrai

console.log("pas pas vrai", !(!true));

// 5. pas pas faux

console.log("pas pas faux", !(!false));
...
console.log ("var1 et vart2", var1 && var2);
