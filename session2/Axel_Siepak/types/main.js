...
console.log( "Si j'aime le foot : " + likeFootball + " est de type " + typeof likeFootball);
...
myNumber = "je voudrais une baguette plus grande que moi";
...
// Ca ne fait pas 15 c'est une concatenation "1" +"2" = 12
